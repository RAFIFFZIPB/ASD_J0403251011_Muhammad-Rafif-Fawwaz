...
# ==========================================================
# ==========================================================
# Materi 4 : Merge Sort dengan Tracing
# ==========================================================

def merge_sort(data, depth=0):

    indent = " " * depth # Indentasi untuk tracing
    print(f"{indent}merge_sort({data})") # Tracing input data
    ...
    print(f"{indent}Divide -> Left = {left_half} | Right = {right_half}") # Tracing pembagian data
    ...
    print(f"{indent}Merge -> {merged}") # Tracing hasil penggabungan
